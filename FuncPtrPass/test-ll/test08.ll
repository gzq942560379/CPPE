; ModuleID = './assign2-tests/test08.c'
source_filename = "./assign2-tests/test08.c"
...
23:                                               ; preds = %22, %14
  ...
  %25 = load i32, i32* %6, align 4, !dbg !79
  %26 = load i32 (i32, i32)*, i32 (i32, i32)** %9, align 8, !dbg !80
  %27 = call i32 @clever(i32 %24, i32 %25, i32 (i32, i32)* %26), !dbg !81
  store i32 %27, i32* %10, align 4, !dbg !77
  ret i32 0, !dbg !82
}
...
!1 = !DIFile(filename: "assign2-tests/test08.c", directory: "/home/gzq/CPPE/FuncPtrPass")
!2 = !{}
...
!8 = !DIFile(filename: "./assign2-tests/test08.c", directory: "/home/gzq/CPPE/FuncPtrPass")
...
!67 = !DILocation(line: 22, column: 14, scope: !68)
!68 = distinct !DILexicalBlock(scope: !60, file: !8, line: 22, column: 14)
!69 = !DILocation(line: 22, column: 16, scope: !68)
!70 = !DILocation(line: 22, column: 14, scope: !60)
!71 = !DILocation(line: 23, column: 17, scope: !72)
!72 = distinct !DILexicalBlock(scope: !68, file: !8, line: 22, column: 24)
