; ModuleID = './assign3-tests/test23.c'
source_filename = "./assign3-tests/test23.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @foo(i32 %0, i32 %1, i32 (i32, i32)* %2) #0 !dbg !32 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @make_simple_alias(i32 (i32, i32)** %0, i32 (i32, i32)** %1) #0 !dbg !45 {
  %3 = alloca i32 (i32, i32)**, align 8
  %4 = alloca i32 (i32, i32)**, align 8
  store i32 (i32, i32)** %0, i32 (i32, i32)*** %3, align 8
  call void @llvm.dbg.declare(metadata i32 (i32, i32)*** %3, metadata !48, metadata !DIExpression()), !dbg !49
  store i32 (i32, i32)** %1, i32 (i32, i32)*** %4, align 8
  call void @llvm.dbg.declare(metadata i32 (i32, i32)*** %4, metadata !50, metadata !DIExpression()), !dbg !51
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %0) #0 !dbg !57 {
  %2 = alloca i8, align 1
  ...
  call void @llvm.dbg.declare(metadata i32 (i32, i32, i32 (i32, i32)*)** %3, metadata !63, metadata !DIExpression()), !dbg !65
  store i32 (i32, i32, i32 (i32, i32)*)* @foo, i32 (i32, i32, i32 (i32, i32)*)** %3, align 8, !dbg !65
  call void @llvm.dbg.declare(metadata i32 (i32, i32)*** %4, metadata !66, metadata !DIExpression()), !dbg !67
  ...
  call void @llvm.dbg.declare(metadata i32 (i32, i32)*** %5, metadata !70, metadata !DIExpression()), !dbg !71
...
!1 = !DIFile(filename: "assign3-tests/test23.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
!3 = !{!4}
...
!13 = distinct !DISubprogram(name: "plus", scope: !14, file: !14, line: 3, type: !6, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!14 = !DIFile(filename: "./assign3-tests/test23.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!15 = !DILocalVariable(name: "a", arg: 1, scope: !13, file: !14, line: 3, type: !8)
!16 = !DILocation(line: 3, column: 14, scope: !13)
!17 = !DILocalVariable(name: "b", arg: 2, scope: !13, file: !14, line: 3, type: !8)
...
!23 = distinct !DISubprogram(name: "minus", scope: !14, file: !14, line: 7, type: !6, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!24 = !DILocalVariable(name: "a", arg: 1, scope: !23, file: !14, line: 7, type: !8)
!25 = !DILocation(line: 7, column: 15, scope: !23)
!26 = !DILocalVariable(name: "b", arg: 2, scope: !23, file: !14, line: 7, type: !8)
...
!32 = distinct !DISubprogram(name: "foo", scope: !14, file: !14, line: 12, type: !33, scopeLine: 13, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!33 = !DISubroutineType(types: !34)
!34 = !{!8, !8, !8, !5}
!35 = !DILocalVariable(name: "a", arg: 1, scope: !32, file: !14, line: 12, type: !8)
!36 = !DILocation(line: 12, column: 13, scope: !32)
!37 = !DILocalVariable(name: "b", arg: 2, scope: !32, file: !14, line: 12, type: !8)
!38 = !DILocation(line: 12, column: 19, scope: !32)
!39 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !32, file: !14, line: 12, type: !5)
...
!45 = distinct !DISubprogram(name: "make_simple_alias", scope: !14, file: !14, line: 17, type: !46, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!46 = !DISubroutineType(types: !47)
!47 = !{null, !4, !4}
!48 = !DILocalVariable(name: "af_ptr", arg: 1, scope: !45, file: !14, line: 17, type: !4)
!49 = !DILocation(line: 17, column: 31, scope: !45)
!50 = !DILocalVariable(name: "bf_ptr", arg: 2, scope: !45, file: !14, line: 17, type: !4)
...
!57 = distinct !DISubprogram(name: "moo", scope: !14, file: !14, line: 22, type: !58, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!58 = !DISubroutineType(types: !59)
!59 = !{!8, !60}
!60 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!61 = !DILocalVariable(name: "x", arg: 1, scope: !57, file: !14, line: 22, type: !60)
!62 = !DILocation(line: 22, column: 14, scope: !57)
!63 = !DILocalVariable(name: "af_ptr", scope: !57, file: !14, line: 24, type: !64)
!64 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !33, size: 64)
!65 = !DILocation(line: 24, column: 11, scope: !57)
!66 = !DILocalVariable(name: "pf_ptr", scope: !57, file: !14, line: 25, type: !4)
!67 = !DILocation(line: 25, column: 12, scope: !57)
!68 = !DILocation(line: 25, column: 48, scope: !57)
!69 = !DILocation(line: 25, column: 29, scope: !57)
!70 = !DILocalVariable(name: "mf_ptr", scope: !57, file: !14, line: 26, type: !4)
...
!77 = distinct !DILexicalBlock(scope: !57, file: !14, line: 28, column: 8)
!78 = !DILocation(line: 28, column: 10, scope: !77)
!79 = !DILocation(line: 28, column: 8, scope: !57)
!80 = !DILocation(line: 29, column: 10, scope: !81)
!81 = distinct !DILexicalBlock(scope: !77, file: !14, line: 28, column: 17)
