; ModuleID = './assign3-tests/test31.c'
source_filename = "./assign3-tests/test31.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 (i32, i32)* @foo(i32 %0, i32 %1, %struct.fptr* %2, %struct.fptr* %3) #0 !dbg !29 {
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr** %7, metadata !41, metadata !DIExpression()), !dbg !42
  store %struct.fptr* %3, %struct.fptr** %8, align 8
  call void @llvm.dbg.declare(metadata %struct.fptr** %8, metadata !43, metadata !DIExpression()), !dbg !44
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 (i32, i32)* @clever(i32 %0, i32 %1, %struct.fptr* %2, %struct.fptr* %3) #0 !dbg !48 {
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr** %8, metadata !53, metadata !DIExpression()), !dbg !54
  store %struct.fptr* %3, %struct.fptr** %9, align 8
  call void @llvm.dbg.declare(metadata %struct.fptr** %9, metadata !55, metadata !DIExpression()), !dbg !56
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !72 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca %struct.fptr, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %7, metadata !82, metadata !DIExpression()), !dbg !83
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %8, metadata !86, metadata !DIExpression()), !dbg !87
  ...
  call void @llvm.dbg.declare(metadata i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %9, metadata !90, metadata !DIExpression()), !dbg !92
  store i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)* @foo, i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %9, align 8, !dbg !92
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %10, metadata !93, metadata !DIExpression()), !dbg !94
...
!1 = !DIFile(filename: "assign3-tests/test31.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
!3 = !{i32 7, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 10.0.0 "}
!7 = distinct !DISubprogram(name: "plus", scope: !8, file: !8, line: 7, type: !9, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!8 = !DIFile(filename: "./assign3-tests/test31.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!9 = !DISubroutineType(types: !10)
!10 = !{!11, !11, !11}
!11 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!12 = !DILocalVariable(name: "a", arg: 1, scope: !7, file: !8, line: 7, type: !11)
!13 = !DILocation(line: 7, column: 14, scope: !7)
!14 = !DILocalVariable(name: "b", arg: 2, scope: !7, file: !8, line: 7, type: !11)
...
!20 = distinct !DISubprogram(name: "minus", scope: !8, file: !8, line: 11, type: !9, scopeLine: 11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!21 = !DILocalVariable(name: "a", arg: 1, scope: !20, file: !8, line: 11, type: !11)
!22 = !DILocation(line: 11, column: 15, scope: !20)
!23 = !DILocalVariable(name: "b", arg: 2, scope: !20, file: !8, line: 11, type: !11)
...
!29 = distinct !DISubprogram(name: "foo", scope: !8, file: !8, line: 15, type: !30, scopeLine: 15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!30 = !DISubroutineType(types: !31)
!31 = !{!32, !11, !11, !33, !33}
!32 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!33 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !34, size: 64)
!34 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fptr", file: !8, line: 2, size: 64, elements: !35)
!35 = !{!36}
!36 = !DIDerivedType(tag: DW_TAG_member, name: "p_fptr", scope: !34, file: !8, line: 4, baseType: !32, size: 64)
!37 = !DILocalVariable(name: "a", arg: 1, scope: !29, file: !8, line: 15, type: !11)
!38 = !DILocation(line: 15, column: 15, scope: !29)
!39 = !DILocalVariable(name: "b", arg: 2, scope: !29, file: !8, line: 15, type: !11)
!40 = !DILocation(line: 15, column: 22, scope: !29)
!41 = !DILocalVariable(name: "c_fptr", arg: 3, scope: !29, file: !8, line: 15, type: !33)
!42 = !DILocation(line: 15, column: 39, scope: !29)
!43 = !DILocalVariable(name: "d_fptr", arg: 4, scope: !29, file: !8, line: 15, type: !33)
...
!48 = distinct !DISubprogram(name: "clever", scope: !8, file: !8, line: 19, type: !30, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!49 = !DILocalVariable(name: "a", arg: 1, scope: !48, file: !8, line: 19, type: !11)
!50 = !DILocation(line: 19, column: 18, scope: !48)
!51 = !DILocalVariable(name: "b", arg: 2, scope: !48, file: !8, line: 19, type: !11)
!52 = !DILocation(line: 19, column: 25, scope: !48)
!53 = !DILocalVariable(name: "c_fptr", arg: 3, scope: !48, file: !8, line: 19, type: !33)
!54 = !DILocation(line: 19, column: 42, scope: !48)
!55 = !DILocalVariable(name: "d_fptr", arg: 4, scope: !48, file: !8, line: 19, type: !33)
!56 = !DILocation(line: 19, column: 64, scope: !48)
!57 = !DILocation(line: 20, column: 6, scope: !58)
!58 = distinct !DILexicalBlock(scope: !48, file: !8, line: 20, column: 6)
...
!65 = distinct !DILexicalBlock(scope: !58, file: !8, line: 21, column: 3)
...
!109 = distinct !DILexicalBlock(scope: !96, file: !8, line: 42, column: 5)
