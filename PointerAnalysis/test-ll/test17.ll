; ModuleID = './assign3-tests/test17.c'
source_filename = "./assign3-tests/test17.c"
...
define dso_local i32 @clever(i32 %0, i32 %1, i32 (i32, i32)* %2, i32 (i32, i32)* %3) #0 !dbg !43 {
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %5, metadata !55, metadata !DIExpression()), !dbg !56
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !69 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32 (i32, i32)*, align 8
  ...
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %7, metadata !79, metadata !DIExpression()), !dbg !80
  store i32 (i32, i32)* @plus, i32 (i32, i32)** %7, align 8, !dbg !80
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %8, metadata !81, metadata !DIExpression()), !dbg !82
  store i32 (i32, i32)* @minus, i32 (i32, i32)** %8, align 8, !dbg !82
  call void @llvm.dbg.declare(metadata %struct.fptr* %9, metadata !83, metadata !DIExpression()), !dbg !84
  %11 = bitcast %struct.fptr* %9 to i8*, !dbg !84
  call void @llvm.memset.p0i8.i64(i8* align 8 %11, i8 0, i64 8, i1 false), !dbg !84
...
!1 = !DIFile(filename: "assign3-tests/test17.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
...
!8 = !DIFile(filename: "./assign3-tests/test17.c", directory: "/home/gzq/CPPE/PointerAnalysis")
...
!33 = !DILocalVariable(name: "a", arg: 1, scope: !29, file: !8, line: 14, type: !11)
!34 = !DILocation(line: 14, column: 15, scope: !29)
!35 = !DILocalVariable(name: "b", arg: 2, scope: !29, file: !8, line: 14, type: !11)
!36 = !DILocation(line: 14, column: 22, scope: !29)
!37 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !29, file: !8, line: 14, type: !32)
!38 = !DILocation(line: 14, column: 31, scope: !29)
!39 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !29, file: !8, line: 14, type: !32)
!40 = !DILocation(line: 14, column: 55, scope: !29)
!41 = !DILocation(line: 15, column: 11, scope: !29)
!42 = !DILocation(line: 15, column: 4, scope: !29)
!43 = distinct !DISubprogram(name: "clever", scope: !8, file: !8, line: 18, type: !44, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!44 = !DISubroutineType(types: !45)
!45 = !{!11, !11, !11, !32, !46}
!46 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fptr", file: !8, line: 2, size: 64, elements: !47)
!47 = !{!48}
!48 = !DIDerivedType(tag: DW_TAG_member, name: "p_fptr", scope: !46, file: !8, line: 4, baseType: !32, size: 64)
!49 = !DILocalVariable(name: "a", arg: 1, scope: !43, file: !8, line: 18, type: !11)
!50 = !DILocation(line: 18, column: 16, scope: !43)
!51 = !DILocalVariable(name: "b", arg: 2, scope: !43, file: !8, line: 18, type: !11)
!52 = !DILocation(line: 18, column: 23, scope: !43)
!53 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !43, file: !8, line: 18, type: !32)
!54 = !DILocation(line: 18, column: 32, scope: !43)
!55 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !43, file: !8, line: 18, type: !46)
!56 = !DILocation(line: 18, column: 63, scope: !43)
!57 = !DILocalVariable(name: "s_fptr", scope: !43, file: !8, line: 19, type: !32)
...
!69 = distinct !DISubprogram(name: "moo", scope: !8, file: !8, line: 25, type: !70, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!70 = !DISubroutineType(types: !71)
!71 = !{!11, !72, !11, !11}
!72 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!73 = !DILocalVariable(name: "x", arg: 1, scope: !69, file: !8, line: 25, type: !72)
!74 = !DILocation(line: 25, column: 14, scope: !69)
!75 = !DILocalVariable(name: "op1", arg: 2, scope: !69, file: !8, line: 25, type: !11)
!76 = !DILocation(line: 25, column: 21, scope: !69)
!77 = !DILocalVariable(name: "op2", arg: 3, scope: !69, file: !8, line: 25, type: !11)
!78 = !DILocation(line: 25, column: 30, scope: !69)
!79 = !DILocalVariable(name: "a_fptr", scope: !69, file: !8, line: 26, type: !32)
!80 = !DILocation(line: 26, column: 11, scope: !69)
!81 = !DILocalVariable(name: "s_fptr", scope: !69, file: !8, line: 27, type: !32)
!82 = !DILocation(line: 27, column: 11, scope: !69)
!83 = !DILocalVariable(name: "t_fptr", scope: !69, file: !8, line: 28, type: !46)
!84 = !DILocation(line: 28, column: 17, scope: !69)
!85 = !DILocation(line: 30, column: 9, scope: !86)
!86 = distinct !DILexicalBlock(scope: !69, file: !8, line: 30, column: 9)
!87 = !DILocation(line: 30, column: 11, scope: !86)
!88 = !DILocation(line: 30, column: 9, scope: !69)
!89 = !DILocation(line: 31, column: 24, scope: !90)
!90 = distinct !DILexicalBlock(scope: !86, file: !8, line: 30, column: 19)
...
!95 = distinct !DILexicalBlock(scope: !86, file: !8, line: 33, column: 14)
!96 = !DILocation(line: 33, column: 16, scope: !95)
!97 = !DILocation(line: 33, column: 14, scope: !86)
!98 = !DILocation(line: 34, column: 24, scope: !99)
!99 = distinct !DILexicalBlock(scope: !95, file: !8, line: 33, column: 24)
...
!103 = !DILocalVariable(name: "result", scope: !69, file: !8, line: 37, type: !104)
