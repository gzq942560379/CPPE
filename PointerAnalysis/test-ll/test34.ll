; ModuleID = './assign3-tests/test34.c'
source_filename = "./assign3-tests/test34.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @make_simple_alias(%struct.wfsptr* %0, %struct.fsptr* %1) #0 !dbg !29 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @make_alias(%struct.wfsptr* %0, %struct.wfsptr* %1) #0 !dbg !54 {
  %3 = alloca %struct.wfsptr*, align 8
  %4 = alloca %struct.wfsptr*, align 8
  store %struct.wfsptr* %0, %struct.wfsptr** %3, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %3, metadata !57, metadata !DIExpression()), !dbg !58
  store %struct.wfsptr* %1, %struct.wfsptr** %4, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %4, metadata !59, metadata !DIExpression()), !dbg !60
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @swap_w(%struct.wfsptr* %0, %struct.wfsptr* %1) #0 !dbg !69 {
  %3 = alloca %struct.wfsptr*, align 8
  %4 = alloca %struct.wfsptr*, align 8
  %5 = alloca %struct.wfsptr, align 8
  store %struct.wfsptr* %0, %struct.wfsptr** %3, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %3, metadata !70, metadata !DIExpression()), !dbg !71
  store %struct.wfsptr* %1, %struct.wfsptr** %4, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %4, metadata !72, metadata !DIExpression()), !dbg !73
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %5, metadata !74, metadata !DIExpression()), !dbg !75
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %7, i8* align 8 %8, i64 8, i1 false), !dbg !77
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %11, i8* align 8 %12, i64 8, i1 false), !dbg !80
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %14, i8* align 8 %15, i64 8, i1 false), !dbg !82
  ret void, !dbg !83
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.fptr* @foo(i32 %0, i32 %1, %struct.wfsptr* %2, %struct.wfsptr* %3) #0 !dbg !84 {
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %8, metadata !91, metadata !DIExpression()), !dbg !92
  store %struct.wfsptr* %3, %struct.wfsptr** %9, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %9, metadata !93, metadata !DIExpression()), !dbg !94
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.fptr* @clever(i32 %0, i32 %1, %struct.fsptr* %2, %struct.fsptr* %3) #0 !dbg !126 {
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr** %8, metadata !135, metadata !DIExpression()), !dbg !136
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %9, metadata !137, metadata !DIExpression()), !dbg !138
  %11 = load %struct.fsptr*, %struct.fsptr** %7, align 8, !dbg !139
  call void @make_simple_alias(%struct.wfsptr* %9, %struct.fsptr* %11), !dbg !140
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %10, metadata !141, metadata !DIExpression()), !dbg !142
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !149 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %6, metadata !157, metadata !DIExpression()), !dbg !158
  call void @llvm.dbg.declare(metadata %struct.fptr* %7, metadata !159, metadata !DIExpression()), !dbg !160
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %8, metadata !163, metadata !DIExpression()), !dbg !164
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr* %9, metadata !167, metadata !DIExpression()), !dbg !168
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr* %10, metadata !171, metadata !DIExpression()), !dbg !172
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %11, metadata !175, metadata !DIExpression()), !dbg !176
  call void @make_simple_alias(%struct.wfsptr* %11, %struct.fsptr* %9), !dbg !177
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %12, metadata !178, metadata !DIExpression()), !dbg !179
  call void @make_simple_alias(%struct.wfsptr* %12, %struct.fsptr* %10), !dbg !180
  call void @llvm.dbg.declare(metadata %struct.fsptr* %13, metadata !181, metadata !DIExpression()), !dbg !182
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %14, metadata !183, metadata !DIExpression()), !dbg !184
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr** %15, metadata !188, metadata !DIExpression()), !dbg !189
...
!1 = !DIFile(filename: "assign3-tests/test34.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
...
!8 = !DIFile(filename: "./assign3-tests/test34.c", directory: "/home/gzq/CPPE/PointerAnalysis")
...
!29 = distinct !DISubprogram(name: "make_simple_alias", scope: !8, file: !8, line: 21, type: !30, scopeLine: 22, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!30 = !DISubroutineType(types: !31)
!31 = !{null, !32, !36}
!32 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !33, size: 64)
!33 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "wfsptr", file: !8, line: 10, size: 64, elements: !34)
!34 = !{!35}
!35 = !DIDerivedType(tag: DW_TAG_member, name: "wfptr", scope: !33, file: !8, line: 12, baseType: !36, size: 64)
!36 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !37, size: 64)
!37 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fsptr", file: !8, line: 6, size: 64, elements: !38)
!38 = !{!39}
!39 = !DIDerivedType(tag: DW_TAG_member, name: "sptr", scope: !37, file: !8, line: 8, baseType: !40, size: 64)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 64)
!41 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fptr", file: !8, line: 2, size: 64, elements: !42)
!42 = !{!43}
!43 = !DIDerivedType(tag: DW_TAG_member, name: "p_fptr", scope: !41, file: !8, line: 4, baseType: !44, size: 64)
!44 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!45 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !29, file: !8, line: 21, type: !32)
!46 = !DILocation(line: 21, column: 40, scope: !29)
!47 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !29, file: !8, line: 21, type: !36)
...
!54 = distinct !DISubprogram(name: "make_alias", scope: !8, file: !8, line: 25, type: !55, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!55 = !DISubroutineType(types: !56)
!56 = !{null, !32, !32}
!57 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !54, file: !8, line: 25, type: !32)
!58 = !DILocation(line: 25, column: 32, scope: !54)
!59 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !54, file: !8, line: 25, type: !32)
...
!69 = distinct !DISubprogram(name: "swap_w", scope: !8, file: !8, line: 29, type: !55, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!70 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !69, file: !8, line: 29, type: !32)
!71 = !DILocation(line: 29, column: 29, scope: !69)
!72 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !69, file: !8, line: 29, type: !32)
!73 = !DILocation(line: 29, column: 52, scope: !69)
!74 = !DILocalVariable(name: "wftemp", scope: !69, file: !8, line: 31, type: !33)
...
!84 = distinct !DISubprogram(name: "foo", scope: !8, file: !8, line: 36, type: !85, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!85 = !DISubroutineType(types: !86)
!86 = !{!40, !11, !11, !32, !32}
!87 = !DILocalVariable(name: "a", arg: 1, scope: !84, file: !8, line: 36, type: !11)
!88 = !DILocation(line: 36, column: 23, scope: !84)
!89 = !DILocalVariable(name: "b", arg: 2, scope: !84, file: !8, line: 36, type: !11)
!90 = !DILocation(line: 36, column: 30, scope: !84)
!91 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !84, file: !8, line: 36, type: !32)
!92 = !DILocation(line: 36, column: 49, scope: !84)
!93 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !84, file: !8, line: 36, type: !32)
!94 = !DILocation(line: 36, column: 73, scope: !84)
!95 = !DILocation(line: 37, column: 7, scope: !96)
!96 = distinct !DILexicalBlock(scope: !84, file: !8, line: 37, column: 7)
...
!103 = distinct !DILexicalBlock(scope: !96, file: !8, line: 38, column: 4)
...
!126 = distinct !DISubprogram(name: "clever", scope: !8, file: !8, line: 47, type: !127, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!127 = !DISubroutineType(types: !128)
!128 = !{!40, !11, !11, !36, !36}
!129 = !DILocalVariable(name: "a", arg: 1, scope: !126, file: !8, line: 47, type: !11)
!130 = !DILocation(line: 47, column: 26, scope: !126)
!131 = !DILocalVariable(name: "b", arg: 2, scope: !126, file: !8, line: 47, type: !11)
!132 = !DILocation(line: 47, column: 33, scope: !126)
!133 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !126, file: !8, line: 47, type: !36)
!134 = !DILocation(line: 47, column: 51, scope: !126)
!135 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !126, file: !8, line: 47, type: !36)
!136 = !DILocation(line: 47, column: 74, scope: !126)
!137 = !DILocalVariable(name: "t1_fptr", scope: !126, file: !8, line: 48, type: !33)
...
!141 = !DILocalVariable(name: "t2_fptr", scope: !126, file: !8, line: 50, type: !33)
...
!149 = distinct !DISubprogram(name: "moo", scope: !8, file: !8, line: 56, type: !150, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!150 = !DISubroutineType(types: !151)
!151 = !{!11, !152, !11, !11}
!152 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!153 = !DILocalVariable(name: "x", arg: 1, scope: !149, file: !8, line: 56, type: !152)
!154 = !DILocation(line: 56, column: 14, scope: !149)
!155 = !DILocalVariable(name: "op1", arg: 2, scope: !149, file: !8, line: 56, type: !11)
!156 = !DILocation(line: 56, column: 21, scope: !149)
!157 = !DILocalVariable(name: "op2", arg: 3, scope: !149, file: !8, line: 56, type: !11)
!158 = !DILocation(line: 56, column: 30, scope: !149)
!159 = !DILocalVariable(name: "a_fptr", scope: !149, file: !8, line: 57, type: !41)
...
!163 = !DILocalVariable(name: "s_fptr", scope: !149, file: !8, line: 59, type: !41)
...
!167 = !DILocalVariable(name: "m_fptr", scope: !149, file: !8, line: 62, type: !37)
...
!171 = !DILocalVariable(name: "n_fptr", scope: !149, file: !8, line: 64, type: !37)
...
!175 = !DILocalVariable(name: "w_fptr", scope: !149, file: !8, line: 67, type: !33)
!176 = !DILocation(line: 67, column: 19, scope: !149)
!177 = !DILocation(line: 68, column: 5, scope: !149)
!178 = !DILocalVariable(name: "x_fptr", scope: !149, file: !8, line: 69, type: !33)
!179 = !DILocation(line: 69, column: 19, scope: !149)
!180 = !DILocation(line: 70, column: 5, scope: !149)
!181 = !DILocalVariable(name: "k_fptr", scope: !149, file: !8, line: 72, type: !37)
!182 = !DILocation(line: 72, column: 18, scope: !149)
!183 = !DILocalVariable(name: "y_fptr", scope: !149, file: !8, line: 73, type: !33)
...
!188 = !DILocalVariable(name: "t_fptr", scope: !149, file: !8, line: 77, type: !40)
