; ModuleID = './assign3-tests/test33.c'
source_filename = "./assign3-tests/test33.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.fptr* @foo(i32 %0, i32 %1, %struct.wfsptr* %2, %struct.wfsptr* %3) #0 !dbg !29 {
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %8, metadata !49, metadata !DIExpression()), !dbg !50
  store %struct.wfsptr* %3, %struct.wfsptr** %9, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %9, metadata !51, metadata !DIExpression()), !dbg !52
...
16:                                               ; preds = %13
  call void @llvm.dbg.declare(metadata %struct.fsptr** %10, metadata !60, metadata !DIExpression()), !dbg !62
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.fptr* @clever(i32 %0, i32 %1, %struct.fsptr* %2, %struct.fsptr* %3) #0 !dbg !93 {
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr** %7, metadata !100, metadata !DIExpression()), !dbg !101
  store %struct.fsptr* %3, %struct.fsptr** %8, align 8
  call void @llvm.dbg.declare(metadata %struct.fsptr** %8, metadata !102, metadata !DIExpression()), !dbg !103
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %9, metadata !104, metadata !DIExpression()), !dbg !105
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %10, metadata !109, metadata !DIExpression()), !dbg !110
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @make_simple_alias(%struct.wfsptr* %0, %struct.fsptr* %1) #0 !dbg !118 {
  %3 = alloca %struct.wfsptr*, align 8
  %4 = alloca %struct.fsptr*, align 8
  store %struct.wfsptr* %0, %struct.wfsptr** %3, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %3, metadata !121, metadata !DIExpression()), !dbg !122
  store %struct.fsptr* %1, %struct.fsptr** %4, align 8
  call void @llvm.dbg.declare(metadata %struct.fsptr** %4, metadata !123, metadata !DIExpression()), !dbg !124
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @make_alias(%struct.wfsptr* %0, %struct.wfsptr* %1) #0 !dbg !130 {
  %3 = alloca %struct.wfsptr*, align 8
  %4 = alloca %struct.wfsptr*, align 8
  store %struct.wfsptr* %0, %struct.wfsptr** %3, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %3, metadata !133, metadata !DIExpression()), !dbg !134
  store %struct.wfsptr* %1, %struct.wfsptr** %4, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %4, metadata !135, metadata !DIExpression()), !dbg !136
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @swap_w(%struct.wfsptr* %0, %struct.wfsptr* %1) #0 !dbg !145 {
  %3 = alloca %struct.wfsptr*, align 8
  %4 = alloca %struct.wfsptr*, align 8
  %5 = alloca %struct.wfsptr, align 8
  store %struct.wfsptr* %0, %struct.wfsptr** %3, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %3, metadata !146, metadata !DIExpression()), !dbg !147
  store %struct.wfsptr* %1, %struct.wfsptr** %4, align 8
  call void @llvm.dbg.declare(metadata %struct.wfsptr** %4, metadata !148, metadata !DIExpression()), !dbg !149
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %5, metadata !150, metadata !DIExpression()), !dbg !151
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %7, i8* align 8 %8, i64 8, i1 false), !dbg !153
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %11, i8* align 8 %12, i64 8, i1 false), !dbg !156
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %14, i8* align 8 %15, i64 8, i1 false), !dbg !158
  ret void, !dbg !159
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !160 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %7, metadata !170, metadata !DIExpression()), !dbg !171
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr* %8, metadata !174, metadata !DIExpression()), !dbg !175
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr* %9, metadata !178, metadata !DIExpression()), !dbg !179
  ...
  call void @llvm.dbg.declare(metadata %struct.fsptr* %10, metadata !182, metadata !DIExpression()), !dbg !183
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %11, metadata !186, metadata !DIExpression()), !dbg !187
  ...
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %12, metadata !190, metadata !DIExpression()), !dbg !191
  call void @make_simple_alias(%struct.wfsptr* %12, %struct.fsptr* %10), !dbg !192
  call void @llvm.dbg.declare(metadata %struct.fsptr* %13, metadata !193, metadata !DIExpression()), !dbg !194
  call void @llvm.dbg.declare(metadata %struct.wfsptr* %14, metadata !195, metadata !DIExpression()), !dbg !196
  ...
  call void @llvm.dbg.declare(metadata %struct.fptr** %15, metadata !202, metadata !DIExpression()), !dbg !203
...
!1 = !DIFile(filename: "assign3-tests/test33.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
...
!8 = !DIFile(filename: "./assign3-tests/test33.c", directory: "/home/gzq/CPPE/PointerAnalysis")
...
!38 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "wfsptr", file: !8, line: 10, size: 64, elements: !39)
!39 = !{!40}
!40 = !DIDerivedType(tag: DW_TAG_member, name: "wfptr", scope: !38, file: !8, line: 12, baseType: !41, size: 64)
!41 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !42, size: 64)
!42 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "fsptr", file: !8, line: 6, size: 64, elements: !43)
!43 = !{!44}
!44 = !DIDerivedType(tag: DW_TAG_member, name: "sptr", scope: !42, file: !8, line: 8, baseType: !32, size: 64)
!45 = !DILocalVariable(name: "a", arg: 1, scope: !29, file: !8, line: 21, type: !11)
!46 = !DILocation(line: 21, column: 23, scope: !29)
!47 = !DILocalVariable(name: "b", arg: 2, scope: !29, file: !8, line: 21, type: !11)
!48 = !DILocation(line: 21, column: 30, scope: !29)
!49 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !29, file: !8, line: 21, type: !37)
!50 = !DILocation(line: 21, column: 49, scope: !29)
!51 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !29, file: !8, line: 21, type: !37)
!52 = !DILocation(line: 21, column: 73, scope: !29)
!53 = !DILocation(line: 22, column: 7, scope: !54)
!54 = distinct !DILexicalBlock(scope: !29, file: !8, line: 22, column: 7)
...
!60 = !DILocalVariable(name: "temp", scope: !61, file: !8, line: 24, type: !41)
!61 = distinct !DILexicalBlock(scope: !54, file: !8, line: 23, column: 4)
...
!93 = distinct !DISubprogram(name: "clever", scope: !8, file: !8, line: 33, type: !94, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!94 = !DISubroutineType(types: !95)
!95 = !{!32, !11, !11, !41, !41}
!96 = !DILocalVariable(name: "a", arg: 1, scope: !93, file: !8, line: 33, type: !11)
!97 = !DILocation(line: 33, column: 26, scope: !93)
!98 = !DILocalVariable(name: "b", arg: 2, scope: !93, file: !8, line: 33, type: !11)
!99 = !DILocation(line: 33, column: 33, scope: !93)
!100 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !93, file: !8, line: 33, type: !41)
!101 = !DILocation(line: 33, column: 51, scope: !93)
!102 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !93, file: !8, line: 33, type: !41)
!103 = !DILocation(line: 33, column: 74, scope: !93)
!104 = !DILocalVariable(name: "t1_fptr", scope: !93, file: !8, line: 34, type: !38)
...
!109 = !DILocalVariable(name: "t2_fptr", scope: !93, file: !8, line: 36, type: !38)
...
!118 = distinct !DISubprogram(name: "make_simple_alias", scope: !8, file: !8, line: 41, type: !119, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!119 = !DISubroutineType(types: !120)
!120 = !{null, !37, !41}
!121 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !118, file: !8, line: 41, type: !37)
!122 = !DILocation(line: 41, column: 40, scope: !118)
!123 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !118, file: !8, line: 41, type: !41)
...
!130 = distinct !DISubprogram(name: "make_alias", scope: !8, file: !8, line: 45, type: !131, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!131 = !DISubroutineType(types: !132)
!132 = !{null, !37, !37}
!133 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !130, file: !8, line: 45, type: !37)
!134 = !DILocation(line: 45, column: 32, scope: !130)
!135 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !130, file: !8, line: 45, type: !37)
...
!145 = distinct !DISubprogram(name: "swap_w", scope: !8, file: !8, line: 49, type: !131, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!146 = !DILocalVariable(name: "a_fptr", arg: 1, scope: !145, file: !8, line: 49, type: !37)
!147 = !DILocation(line: 49, column: 29, scope: !145)
!148 = !DILocalVariable(name: "b_fptr", arg: 2, scope: !145, file: !8, line: 49, type: !37)
!149 = !DILocation(line: 49, column: 52, scope: !145)
!150 = !DILocalVariable(name: "wftemp", scope: !145, file: !8, line: 51, type: !38)
...
!160 = distinct !DISubprogram(name: "moo", scope: !8, file: !8, line: 55, type: !161, scopeLine: 55, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!161 = !DISubroutineType(types: !162)
!162 = !{!11, !163, !11, !11}
!163 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!164 = !DILocalVariable(name: "x", arg: 1, scope: !160, file: !8, line: 55, type: !163)
!165 = !DILocation(line: 55, column: 14, scope: !160)
!166 = !DILocalVariable(name: "op1", arg: 2, scope: !160, file: !8, line: 55, type: !11)
!167 = !DILocation(line: 55, column: 21, scope: !160)
!168 = !DILocalVariable(name: "op2", arg: 3, scope: !160, file: !8, line: 55, type: !11)
!169 = !DILocation(line: 55, column: 30, scope: !160)
!170 = !DILocalVariable(name: "a_fptr", scope: !160, file: !8, line: 56, type: !33)
...
!174 = !DILocalVariable(name: "s_fptr", scope: !160, file: !8, line: 58, type: !33)
...
!178 = !DILocalVariable(name: "m_fptr", scope: !160, file: !8, line: 61, type: !42)
...
!182 = !DILocalVariable(name: "n_fptr", scope: !160, file: !8, line: 63, type: !42)
...
!186 = !DILocalVariable(name: "w_fptr", scope: !160, file: !8, line: 66, type: !38)
...
!190 = !DILocalVariable(name: "x_fptr", scope: !160, file: !8, line: 69, type: !38)
!191 = !DILocation(line: 69, column: 19, scope: !160)
!192 = !DILocation(line: 70, column: 5, scope: !160)
!193 = !DILocalVariable(name: "k_fptr", scope: !160, file: !8, line: 72, type: !42)
!194 = !DILocation(line: 72, column: 18, scope: !160)
!195 = !DILocalVariable(name: "y_fptr", scope: !160, file: !8, line: 73, type: !38)
...
!202 = !DILocalVariable(name: "t_fptr", scope: !160, file: !8, line: 79, type: !32)
