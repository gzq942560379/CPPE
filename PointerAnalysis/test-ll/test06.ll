; ModuleID = './assign3-tests/test06.c'
source_filename = "./assign3-tests/test06.c"
...
define dso_local void @foo(i32 %0) #0 !dbg !32 {
  ...
  call void @llvm.dbg.declare(metadata i32 (i32, i32)*** %3, metadata !37, metadata !DIExpression()), !dbg !38
...
!1 = !DIFile(filename: "assign3-tests/test06.c", directory: "/home/gzq/CPPE/PointerAnalysis")
!2 = !{}
!3 = !{!4}
...
!14 = !DIFile(filename: "./assign3-tests/test06.c", directory: "/home/gzq/CPPE/PointerAnalysis")
...
!32 = distinct !DISubprogram(name: "foo", scope: !14, file: !14, line: 9, type: !33, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!33 = !DISubroutineType(types: !34)
!34 = !{null, !8}
!35 = !DILocalVariable(name: "x", arg: 1, scope: !32, file: !14, line: 9, type: !8)
!36 = !DILocation(line: 9, column: 14, scope: !32)
!37 = !DILocalVariable(name: "a_fptr", scope: !32, file: !14, line: 11, type: !4)
...
!42 = distinct !DILexicalBlock(scope: !32, file: !14, line: 12, column: 5)
!43 = !DILocation(line: 12, column: 6, scope: !42)
!44 = !DILocation(line: 12, column: 5, scope: !32)
!45 = !DILocation(line: 14, column: 4, scope: !46)
!46 = distinct !DILexicalBlock(scope: !42, file: !14, line: 13, column: 2)
...
!57 = distinct !DILexicalBlock(scope: !42, file: !14, line: 18, column: 2)
